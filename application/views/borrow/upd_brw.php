		...
		<div class="row">
			<div class="input-field col s6 m6 l6 xl6">
				<i class="material-icons prefix">file_upload</i>
					<input type="text" name="item" required minlength="3" value="<?= $emprestimos->item?>" placeholder="Digite o Nome do Item">
				<label for="item">Nome do Item</label>
			</div>
			<div class="input-field col s6 m6 l6 xl6">
				<i class="material-icons prefix">account_circle</i>
					<input type="text" name="contato" minlength="3" value="<?= $emprestimos->contato?>" required placeholder="Digite o Nome do Contato">
		...
		<div class="row">
			<div class="input-field col s6 m6 l6 xl6">
		       	<i class="material-icons prefix">event</i>
		            <input type="text" required name="data" value="<?=  date('d/m/Y', strtotime($emprestimos->data))?>" class="datepicker">
		...
		<div class="row">
		  	<div class="input-field col s12">
				<i class="material-icons prefix">border_color</i>
					<textarea class="materialize-textarea" name="detalhes" data-length="255"><?= $emprestimos->detalhes?></textarea>
				<label for="detalhes">Detalhes</label>
			</div>
		</div>
			<input type="hidden" name="user_id" value="<?= $this->session->userdata('Logado')['id'] ?>">
			<input type="hidden" name="situacao" value="1">
			<input type="hidden" name="id" value="<?= $emprestimos->id?>">
